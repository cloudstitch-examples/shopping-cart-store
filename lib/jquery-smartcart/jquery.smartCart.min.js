...
;(function ($, window, document, undefined) {
    ...
    var defaults = {
            ...
            submitSettings: {
                submitType: 'form', // form, paypal, ajax, stripe
        ...
        _submitCart: function () {
            ...
            switch(this.options.submitSettings.submitType){
                ...
                case 'paypal':
                    ...
                    break;
                case 'stripe':
                    formElm.children('.sc-stripe-input').remove();
                    // Add paypal specific fields for cart products
                    var stripeAmount = 0;
                    ...
                    $.each(this.cart, function( i, p ) {   
                        var itemNumber = i + 1;
                        stripeAmount += (parseInt(mi._getValueOrEmpty(p[mi.options.paramSettings.productQuantity])) * parseFloat(mi._getValueOrEmpty(p[mi.options.paramSettings.productPrice])));
                        stripeDescription += "[" + mi._getValueOrEmpty(p[mi.options.paramSettings.productQuantity]) + "] " + mi._getValueOrEmpty(p[mi.options.paramSettings.productName] + " at $" + mi._getValueOrEmpty(p[mi.options.paramSettings.productPrice]) + "\n");
                    });
                    console.log(stripeCurrency, stripeAmount);
                    console.log(stripeDescription);
                    formElm.append('<input class="sc-stripe-input" name="stripeAmount" value="' + stripeAmount + '" type="hidden">')
                    formElm.append('<input class="sc-stripe-input" name="stripeCurrency" value="' + stripeCurrency + '" type="hidden">')
                    formElm.append('<input class="sc-stripe-input" name="stripeDescription" value="' + stripeDescription + '" type="hidden">')
                    this._triggerEvent("cartSubmitted", [this.cart]);                    
                    break;
                case 'awslist':                    
                default:
